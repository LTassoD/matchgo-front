...
let MatchingController = class MatchingController {
    ...
    run(ofertaId) { return this.service.runMatching(ofertaId); }
    getMatches(ofertaId, sortBy, order) { return this.service.getMatches(ofertaId, sortBy, order); }
};
exports.MatchingController = MatchingController;
__decorate([
    (0, common_1.Post)('run'),
    __param(0, (0, common_1.Query)('oferta_id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], MatchingController.prototype, "run", null);
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)('oferta_id')),
