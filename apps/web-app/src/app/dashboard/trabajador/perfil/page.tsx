  ...
  const loadPerfil = async () => {
    ...
    try {
      if (isSupabaseConfigured && supabase) {
        ...
        let perfilData = await trabajadorApi.get(authUser.id).catch(() => null)
        
        console.log('Query result:', { perfilData })
        ...
        if (perfilData) {
          ...
          perfilData = await trabajadorApi.create({
          ...
          console.log('Nuevo perfil:', perfilData)
          setPerfil(perfilData)
        }
      } else {
  ...
  const handleGuardar = async () => {
    ...
    try {
      if (isSupabaseConfigured && perfil) {
        await trabajadorApi.update(perfil.id, {
